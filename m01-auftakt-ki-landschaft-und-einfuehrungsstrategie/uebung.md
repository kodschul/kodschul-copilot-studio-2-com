# M01 Übung: Softwarelandschaft & KI-Einführungsoptionen

## Zeit

20 Minuten (Aufgabe 1) + 20 Minuten (Aufgabe 2), je in Kleingruppen (2–3 Personen)
...
2. Zeichnet für jeden Prozess, bei dem Daten zwischen zwei Systemen manuell übertragen werden, einen
   Pfeil zwischen den Systemen ein.
3. Markiert die 2–3 Pfeile, bei denen am meisten Zeit durch manuelle Übertragung verloren geht.
...
2. Als Spalten: Datenschutz/Datensicherheit, Kosten/Lizenzen, Kontrolle & Nachvollziehbarkeit,
   Pflegeaufwand, vorhandenes Know-how.
3. Bewertet jede Zelle kurz mit +/o/− aus Sicht von EFG.
4. Diskutiert: welche Option passt aktuell am besten zu den beiden EFG-Use-Cases (Datenextraktion,
   Aufmaßprüfung)?

## Abnahme

- Skizze/Liste der größten Medienbrüche liegt vor.
- Bewertungstabelle für die Einführungsoptionen ist ausgefüllt.
- Begründung, welche Option(en) für EFG aktuell sinnvoll erscheinen, wurde mündlich vorgestellt.
